...
[![GitHub release (latest by date)](https://img.shields.io/github/v/release/yahoojapan/athenz-authorizer?style=flat-square&label=Github%20version)](https://github.com/wfen/athenz-authorizer/releases/latest)
...
[![Go Report Card](https://goreportcard.com/badge/github.com/wfen/athenz-authorizer)](https://goreportcard.com/report/github.com/wfen/athenz-authorizer)
[![GolangCI](https://golangci.com/badges/github.com/wfen/athenz-authorizer.svg?style=flat-square)](https://golangci.com/r/github.com/wfen/athenz-authorizer)
...
[![GoDoc](http://godoc.org/github.com/wfen/athenz-authorizer?status.svg)](http://godoc.org/github.com/wfen/athenz-authorizer)
...
import (
    ...
    authorizerd "github.com/wfen/athenz-authorizer/v5"
)
...
Note that only for contributions to the `athenz-authorizer` repository on the [GitHub](https://github.com/wfen/athenz-authorizer), the contributors of them shall be deemed to have agreed to the CLA without individual written agreements.
